...
/* First line on every page: who wrote it and when, set quietly so it does
   not compete with the title underneath. */
.byline { font-family: var(--mono, monospace); font-size: .72rem;
  letter-spacing: .14em; text-transform: uppercase; color: var(--muted);
  opacity: .7; margin: 0 0 1rem; }
.disclaimer { margin: 3rem 0 0; padding-top: 1rem;
