...
# Benchmarks are drawn without color: a fine dotted line in the page's own
# ink, then progressively looser grey dashes if a chart carries more than one.
BENCH = [
